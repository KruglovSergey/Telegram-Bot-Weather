...
namespace WPF_SomeName200_bot
{
    public class TgMsgClient
    {
        ...
        private SoundPlayer incMsgSound = new SoundPlayer();                    //звук входящего сообщения
        ...
        private void Bot_OnMessage(object sender, Telegram.Bot.Args.MessageEventArgs e)
        {
            ...
            var WeatherKey = new InlineKeyboardMarkup(new[]
           {
            ...
            incMsgSound.Stream = Properties.Resources.incMsg;
            ...
            if (msg.Text.Contains("weather"))   //Показ клавиш с городами, если пользователь ввел weather
            {
